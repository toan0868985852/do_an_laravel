...
<section class="section">
    ...
    <div class="container">
        <h1>Event Grid</h1>
        <p class="link-title"><a href="#">Home</a> <i class="fa fa-angle-right"></i> <b>Event Grid</b></p>
    </div>
</section>
<div class="section-img">
    ...
    <div class="navigation">
        ...
        <div class="navigation-img">
            <div class="filter child plants">
                <img src="{{asset('fronend/home/img/projects/21.jpg')}}" alt="">
                <div class="overlay-1">
