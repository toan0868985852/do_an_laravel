            ...
            <div class="col-lg-4 col-md-12">
                <div class="widget-area">
                    ...
                    <div class="widget-post">
                        <h3>Popular Posts</h3>
                        <div class="list-post">
                            <a href="{{url('home/blog_details_1/1')}}"><img style="float: left;width: 80px;height: 80px; margin-bottom: -3px;" src="{{asset('fronend/img_blog/causes2.png')}}"></a>
                            <div class="info">
                                <p>June 30,2019</p>
                        ...
                        <div class="list-post">
                            <a href="{{url('home/blog_details_1/2')}}"><img style="float: left;width: 80px;height: 80px;margin-bottom: -3px;" src="{{asset('fronend/img_blog/causes3.png')}}"></a>
                            <div class="info">
                                <p>June 30,2019</p>
                        ...
                        <div class="list-post">
                            <a href="{{url('home/blog_details_1/3')}}"><img style="float: left;width: 80px;height: 80px;margin-bottom: -3px;" src="{{asset('fronend/img_blog/causes4.png')}}"></a>
                            <div class="info">
                                <p>June 30,2019</p>
                        ...
                        <div class="list-post">
                            <a href="{{url('home/blog_details_1/4')}}"><img style="float: left;width: 80px;height: 80px;margin-bottom: -3px;" src="{{asset('fronend/img_blog/causes5.png')}}"></a>
                            <div class="info">
                                <p>June 30,2019</p>
                                <a href="#"><h4>Delicate contempt received two yet advanced</h4></a>
                            </div>
